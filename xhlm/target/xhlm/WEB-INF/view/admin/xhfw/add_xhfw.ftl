...
<body>
	<div id="main">
		<div id="content">
			<h3 class="title">新增协会服务</h3>
			<form class="f0" action="${appDomain}/admin/xhfw/add_xhfw.htm" method="POST">			
				<table class="tbls">
			  <tr>
			    <th>标题:</th>
			    ...
			    <tr>
			    <th>周期:</th>
			     <td><input class="text" type="text" name="zq" maxlength="20"/>
				</td>
			  </tr>
			  <tr>
			    <th>要求:</th>
			     <td><input class="text" type="text" name="yq" maxlength="20"/>
				</td>
			  </tr>
			  <tr>
			    <th>招牌:</th>
			     <td>
			     	<img src="" id="imgZp" width="100px" height="125px" /><br />
					<input width="60" type="hidden" id="zp" name="zp">
