...
<body>
	<div id="main">
		<div id="content">
			<h3 class="title">更新企业条目信息</h3>
			<form action="${appDomain}/admin/qytm/edit_qytm.htm" method="POST">
				<input type="hidden" name="id" value="${qytm.id}" />
				<table class="tbls">
				   <tr>
				    <th >条目</th>
				    <td>
				    <input type="text" name="tmname" value="${qytm.tmname}"/></td>
				  </tr>
				    <tr>
				    <th>类型</th>
