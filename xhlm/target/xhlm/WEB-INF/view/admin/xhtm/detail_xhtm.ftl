...
<body>
	<div id="main">
		<div id="content">
			<h3 class="title">协会条目详细信息</h3>
			<form action="${appDomain}/admin/xhtm/edit.htm" method="POST">
				<input type="hidden" name="id" value="${xhtm.id}" />
				<table class="tbls">
				   <tr>
				    <th >条目</th>
				    <td>
				    <input type="text" name="tmname" value="${xhtm.tmname}" readonly="readonly"/></td>
				  </tr>
				    <tr>
				    <th>类型</th>
