...
<html>
	<head>
		...
		$(document).ready(function(){
		    ...
		    $("#addBtn").click(function(){
		        var url = "${appDomain}/admin/ptfwdetail/add_ptfwdetail.htm";
		    ...
		    $(".act-update").click(function(){
		        var url = "${appDomain}/admin/ptfwdetail/edit_ptfwdetail.htm?id=" + $(this).attr("alt") + "&r=" + Math.random();
		        var param = 'dialogWidth=720px;dialogHeight=770px;status=no;center=yes;scroll=no';
		        var val = window.showModalDialog(url, '', param);
		        if (val == 'refresh') {
		            alert("操作成功");
		    ...
		    $(".act-delete").click(function(){
		        var url = "${appDomain}/admin/ptfwdetail/delete_ptfwdetail.htm?id=" + $(this).attr("alt");
		        if (confirm("确定删除该分类？")) {
		    ...
		    $("#delBatchBtn").click(function(){
		        ...
		        if (confirm("确定删除所选分类?")) {
		            ...
		            var url = "${appDomain}/admin/ptfwdetail/delete_ptfwdetailArray.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
		...
		var url = "${appDomain}/admin/ptfwdetail/ptfwdetail_detail.htm?id=" + messageId;
    ...
    <body>
        <div id="main">
            <div id="content">    
             <h3 class="title">服务报名列表页面</h3>              
                <form id="ptfwdetailForm" name="ptfwdetailForm" action="${appDomain}/admin/ptfwdetail/list.htm" method="GET">                
	              <div class="search">
					<ul>
                		<li>平台服务:<input class="sch-txt-more" type="text" name="title" value="${page.title}" /></li>
	                ...
	                <div class="list">
                     <div class="opt-btn">
	                    ...
	                    <table class="list-info">
	                        ...
	                        <#list page.ptfwDetailList as ptfwdetail>
								<tr>
									<td width="3%">
		                                <input type="checkbox" name="chkItem" value=${ptfwdetail.id} />
		                            </td>
									<td>${ptfwdetail.title}</td>
									<td>${ptfwdetail.userName}</td>
									<td>${ptfwdetail.createDate?datetime}</td>
								</tr>
							</#list>
	                        </tr>
	                    </table>
