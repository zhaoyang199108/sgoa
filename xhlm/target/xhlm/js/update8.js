...
Hongru.fader = function(){
 function init(anchor,options){
  ...
  nav_wp.id = 'fader-nav';
  nav_wp.style.cssText = 'position:absolute;right:0;bottom:0;padding:5px 0;';
  ...
  this.textH = nav_wp.offsetHeight;
    alt.style.cssText = 'color:#054CB6;font-size:14px;text-align:left;font-weight:bold;padding-left:20px;margin:0;position:absolute;left:0;bottom:0;overflow:hidden;width:100%;background:#fff;opacity:0.7;filter:alpha(opacity=65);';
