	...
	<div id="main">
		<div id="content">
			...
			<input type="hidden" name="id" value="${xwk.id}" />
			  ...
			  <tr>
			    <th >标题:</th>
			    <td><input class="text" type="text" name="title" maxlength="20" value="${xwk.title}"/>
				</td>
			  </tr>
			    <tr>
			    <th>行业:</th>
			  ...
			  <th>出处:</th>
			     <td><input class="text" type="text" name="cc" maxlength="20" value="${xwk.cc}" />
				</td>
			  </tr>
			  <tr>
			    <th>时间:</th>
			     <td><input class="text" type="text" name="releaseDate" maxlength="20" value="${xwk.releaseDate}" />
				</td>
			  </tr>				    
			    <tr>
			    <th>内容:</th>
			     <td>
			     	<textarea id="ct" name="content" rows="25" style="width:100%; border: 1px">${xwk.content}</textarea>
				</td>
			  </tr>
			</table>
