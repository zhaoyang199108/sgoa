...
<body>
	<div id="main">
		<div id="content">
			<h3 class="title">新增协会新闻</h3>
			<form class="f0" action="${appDomain}/admin/xhxw/add_xhxw.htm" method="POST">			
				<table class="tbls">
			  <tr>
			    <th>标题:</th>
			    ...
			    <tr>
			    <th>出处:</th>
			     <td><input class="text" type="text" name="cc" maxlength="20"/>
				</td>
			  </tr>
			  <tr>
			    <th>时间:</th>
			     <td><input class="text" type="text" name="releaseDate" maxlength="20"/>
				</td>
			  </tr>			  
			    <tr>
			    <th>内容:</th>
