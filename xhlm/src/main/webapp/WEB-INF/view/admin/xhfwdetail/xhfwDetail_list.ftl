	...
	<head>
		...
		$(document).ready(function(){
		    ...
		    $("#addBtn").click(function(){
		        var url = "${appDomain}/admin/xhfwdetail/add_xhfwdetail.htm";
		    ...
		    $(".act-update").click(function(){
		        var url = "${appDomain}/admin/xhfwdetail/edit_xhfwdetail.htm?id=" + $(this).attr("alt") + "&r=" + Math.random();
		        var param = 'dialogWidth=720px;dialogHeight=770px;status=no;center=yes;scroll=no';
		        var val = window.showModalDialog(url, '', param);
		        if (val == 'refresh') {
		            alert("操作成功");
		    ...
		    $(".act-delete").click(function(){
		        var url = "${appDomain}/admin/xhfwdetail/delete_xhfwdetail.htm?id=" + $(this).attr("alt");
		        if (confirm("确定删除该分类？")) {
		    ...
		    $("#delBatchBtn").click(function(){
		        ...
		        if (confirm("确定删除所选分类?")) {
		            ...
		            var url = "${appDomain}/admin/xhfwdetail/delete_xhfwdetailArray.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
		...
		var url = "${appDomain}/admin/xhfwdetail/xhfwdetail_detail.htm?id=" + messageId;
        ...
        <div id="main">
            <div id="content">    
             <h3 class="title">服务报名列表页面</h3>              
                <form id="xhfwdetailForm" name="xhfwdetailForm" action="${appDomain}/admin/xhfwdetail/list.htm" method="GET">                
	              <div class="search">
					<ul>
	                ...
	                <div class="list">
                     <div class="opt-btn">
	                    ...
	                    <table class="list-info">
	                        ...
	                        <#list page.xhfwDetailList as xhfwdetail>
								<tr>
									<td width="3%">
		                                <input type="checkbox" name="chkItem" value=${xhfwdetail.id} />
		                            </td>
									<td>${xhfwdetail.title}</td>
									<td>${xhfwdetail.userName}</td>
									<td>${xhfwdetail.createDate?datetime}</td>
								</tr>
							</#list>
	                        </tr>
	                    </table>
