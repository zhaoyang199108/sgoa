...
(function($){
	...
	function _setCodeStyle(eid, codeType, codeLength){
		...
		var htmlCode=''
		if(!settings.inputID){
			htmlCode='<div><input id="ehong-code-input" type="text" maxlength="4" /></div>';
		}
		htmlCode+='<div id="ehong-code" class="ehong-idcode-val ehong-idcode-val';
		htmlCode+=String(randNum);
		htmlCode+='" href="#" onblur="return false" onfocus="return false" oncontextmenu="return false" onclick="$.idcode.setCode()">' + _setStyle(codeObj) + '</div>'  +'</span>';
		$(eid).html(htmlCode);
