...
function GooCalendar(InputID,property){
	...
	temp="<div class='top'><b class='arrow'><div class='left'></div></b><b class='arrow' style='float:right;'><div class='right'></div></b></div>"+
		"<div class='week'></div><div class='day'></div><div class='bottom'><div class='btn'>today</div><div class='time'></div>";
	if(!this.$fixid)
		temp+="<div class='btn' style='float:right'>cancel</div>";
	temp+="</div>";
	...
	this.preMonth=function(){
		...
		if(month>1) month--; 
			...
			//this.$tempDate.year=year;
			this.$selectYear.children("span").attr("value",year);
		}
	...
	this.nextMonth=function(){
		...
		if(month<12) month++;
			...
			month=1;
			year++; this.$selectYear.children("span").text(year);
			this.$selectYear.children("span").val(year);
		}
		this.$selectMonth.children("span").text(this.$month[month-1]);
