...
import com.bcqsoft.xhlm.common.util.FileUtil;
import com.bcqsoft.xhlm.common.util.ImageUtil;
import com.bcqsoft.xhlm.service.common.UploadService;
...
public class UploadServiceImpl implements UploadService {
	...
	public String uploadNewsImage(MultipartFile mf, String dir)
		...
		// 返回上传图片路径(web访问路径)
		return appendPath(uploadDomain, path);
	}
	...
	private String appendUploadDir(MultipartFile mf, String dir) {
		...
		buf.append(dir);
		buf.append("/");
		// 文件夹按日期分类(格式:20111121)
		buf.append(DateUtil.getToday());
		buf.append("/");
		// 文件名(格式:当前时间(135523554.jpg))
		buf.append(DateUtil.getNow());
