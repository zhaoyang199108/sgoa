    ...
    <body>
        <div id="main">
         <div class="main_nav">
            ...
            <div id="content">
            	<form id="newsForm" name="newsForm" action="${appDomain}/news/my_draft_list.htm" method="GET">
	                ...
	                <div class="ct-top">
	                 <div class="search-bk">
	                    ...
	                    <div class="btn-bk">
	                        <a class="add-btn" href="${appDomain}/news/add_news.htm?sort=${sort}">新增</a>
		                        ...
		                        <tr>
		                            ...
		                            <td style="width:60px;"><#if news.sort == 1>每日要情<#else>简报</#if></td>		                            
		                             <td class="td-btn" width="10%"">
			                            	<a class="act-btn edit" href="${appDomain}/news/edit_news.htm?id=${news.id}" title="更新">更新</a>
