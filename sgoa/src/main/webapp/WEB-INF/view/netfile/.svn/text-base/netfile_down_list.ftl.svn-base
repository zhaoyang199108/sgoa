    ...
    <body>
        <div id="main">
         ...
         <#include "netfile/menu.ftl">
            <div id="content">
                <form id="listForm" name="listForm" action="${appDomain}/netFile/shareDownList.htm" method="GET">
                 <div class="ct-top">
	                    ...
	                    <table class="list">
	                        ...
	                        <#list page.netFileList as netFile >
								<tr>
									...
									<td class="td-btn" width="10%""><a class="act-btn edit" href="#" title="查看" alt="${netFile.id}">查看</a>
									<a class="act-btn act-down" href="#" alt="${netFile.srcFileName}">下载</a></td>
								</tr>
							</#list>
	                        </tr>
	                    </table>
