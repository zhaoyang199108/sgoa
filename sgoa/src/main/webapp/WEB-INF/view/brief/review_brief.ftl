	...
	<script type="text/javascript">
            $(document).ready(function(){
                $("#draftBtn").click(function(){
                	...
                	// 添加校验
                	$('form').attr("action", "${appDomain}/brief/add_brief_review.htm");
                	 if(DoCheckSubmit())
                    {
                    if(SaveSignature()) {
                    	$('form').submit();
		    ...
		    $("#rebackBtn").click(function(){
                    ...
                    // 添加校验
                    // 选择提交返回人
                    var url = "${appDomain}/common/choose_reback_user5.htm?step="+$("#step").val()+"&id=" + $(this).attr("alt") + "&r=" + Math.random();
                    var param = 'dialogWidth=380px;dialogHeight=380px;status=no;center=yes;scroll=no';
                    ...
                    $('form').attr("action", "${appDomain}/brief/brief_reback.htm");
		    		 if(DoCheckSubmit())
                    {
                    	if(SaveSignature()) {
                    	$('form').submit();
...
<div id="main">
	...
	<#include "brief/menu.ftl">
		<div id="content">
			 <form class="f0" action="${appDomain}/brief/add_brief_review.htm" method="POST">
			  <div class="ct">
				<table class="ftb">
			    ...
			    <tr>
				  ...
				  <tr class="act">
                    ...
                    <#if approvalDetailForStatus == 'Y'>
		             ...
		             <input id="rebackBtn" class="btn" name="draftBtn" type="button" alt="${news.id}" value="返 回" />
		              </#if>
