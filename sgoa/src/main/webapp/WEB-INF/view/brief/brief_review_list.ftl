    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="newsForm" name="newsForm" action="${appDomain}/brief/brief_review_list.htm" method="GET">
		                        ...
		                        <tr>
		                            ...
		                            <td style="width:60px;"><#if news.sort == 1>每日要情<#else>简报</#if></td>
		                             <td class="td-btn" width="20%"">
		                             		<a class="act-btn review" href="${appDomain}/brief/edit_brief_review.htm?id=${news.id}" title="${pageButtonName}">${pageButtonName}</a>
