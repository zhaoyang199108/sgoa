...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            // 删除按钮点击事件
		    $(".del").click(function(){
		        var url = "${appDomain}/brief/del_brief.htm?id=" + $(this).attr("alt");
		        if (confirm("确定删除该信息？")) {
		    ...
		    $(".delete-btn").click(function(){
		        ...
		        if (item.length == 0) {
		          ...
		          if (confirm("确定删除所选信息？")) {
		            ...
		            var url = "${appDomain}/brief/delete_briefArray.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
    ...
    <body>
        <div id="main">
         <div class="main_nav">
            ...
            <div id="content">
            	<form id="newsForm" name="newsForm" action="${appDomain}/brief/my_drafts_list.htm" method="GET">
	                ...
	                <div class="ct-top">
	                 <div class="search-bk">
	                    ...
	                    <div class="btn-bk">
	                        <a class="add-btn" href="${appDomain}/brief/add_brief.htm?sort=${sort}">新增</a>
		                        ...
		                        <tr>
		                            ...
		                            <td style="width:60px;"><#if news.sort == 1>每日要情<#else>简报</#if></td>
		                             <td class="td-btn" width="10%"">
			                            	<a class="act-btn edit" href="${appDomain}/brief/edit_brief.htm?id=${news.id}" title="更新">更新</a>
