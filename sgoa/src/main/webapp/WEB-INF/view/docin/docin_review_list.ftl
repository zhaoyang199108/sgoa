    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="docinForm" name="docinForm" action="${appDomain}/docin/docin_review_list.htm" method="GET">
	                <div class="ct-top">
	                	<div class="search-bk">
							<span>标题：</span>
	                    ...
	                    <table class="list">
	                        ...
	                        <#list page.docinList as docin>
		                        <tr>
		                            ...
		                            <td class="left"><label style="width:380px;"><a href="${appDomain}/docin/edit_docin_review.htm?id=${docin.id}">${docin.title}</a></label></td>
		                            <td>${docin.fileNum}</td>
		                            <!--<td>${docin.textTime}</td>-->
		                            <td>${docin.fileDept}</td>
		                             <td class="td-btn" width="15%"">
		                             		<a class="act-btn review" href="${appDomain}/docin/edit_docin_review.htm?id=${docin.id}" title="${pageButtonName}">${pageButtonName}</a>
