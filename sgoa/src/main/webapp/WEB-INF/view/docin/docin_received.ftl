        ...
        <script type="text/javascript">
        	$(document).ready(function(){
				...
				$(".receipt").click(function(){
				 	var temp="docin";
					var url = "${appDomain}/docin/docin_receipt.htm?id=" +  $(this).attr("alt")+ "&r=" + Math.random();
    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="docinForm" name="docinForm" action="${appDomain}/docin/docin_received.htm" method="GET">
	                <div class="ct-top">
	                	<div class="search-bk">
							<span>标题：</span>
		                            ...
		                            <td>${docin.fileDept}</td>
		                             <td class="td-btn" width="15%"">
			                            	<a class="act-btn detail" href="${appDomain}/docin/detail_qf.htm?id=${docin.id}" title="详细">详细</a>
			                            	 ...
			                            	 <#if docin.boxStatus!=1>
											<a class="act-btn receipt" href="#"   alt="${docin.id}" title="回执">回执</a>
											<#else>
