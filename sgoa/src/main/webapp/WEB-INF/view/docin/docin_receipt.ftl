...
<body>
	<div class="sow">
			...
			<form class="f0" action="${appDomain}/docin/docin_receipt.htm" method="POST">
				<table class="ftb">
					<input type="hidden"  name="docinId" value="${docinId}" />
			
				<tr>
					<th style="width:20%;">回执内容:</th>
					<td>						
						<textarea class="text" type="text" name="stituation" style="width:90%;"></textarea>
					</td>
				</tr>
				<tr class="act">
				   <td colspan="2">				
