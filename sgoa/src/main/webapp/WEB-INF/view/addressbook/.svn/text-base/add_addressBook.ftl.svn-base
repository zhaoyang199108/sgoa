...
<html>
    ...
    <body>
			<div  class="xjlx">
			<form class="f0" action="${appDomain}/addressBook/add_addressBook.htm" method="POST" enctype="multipart/form-data">
			 <table class="tableblock">
			     <tr>
			      <td   colspan="3" class="tableheader02"><b>&nbsp;分组</b></td>
			    </tr>
			    <tr> <td> 分组：</td>
			      <td colspan="2"  >
			        <select name="typeId">
                		      ...
                		      <option value="${addressBookType.id}" > ${addressBookType.typeName} </option>
                              </#list>
                         </select>
			      </td>
			    </tr>
			...
			<img width="248" height="208" id="imgPhoto">
			    ...
			    <tr>
			      <td   >年龄：</td>
			      <td  >
			        <input type="text"  maxlength="3" size="10" name="age">
