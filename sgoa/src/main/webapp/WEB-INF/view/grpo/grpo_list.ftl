	...
	<head>
		...
		$(document).ready(function(){
		    ...
		    $(".add-btn").click(function(){
		        var url = "${appDomain}/grpo/add_grpo.htm" + "?r=" + Math.random();
		    ...
		    // 更新按钮点击事件
		    $(".edit").click(function(){
		        var url = "${appDomain}/grpo/grpo_edit.htm?id=" + $(this).attr("alt") + "&r=" + Math.random();
		        var param = 'dialogWidth=880px;dialogHeight=200px;status=no;center=yes;scroll=no';
		        var val = window.showModalDialog(url, '', param);
		        if (val == 'refresh') {
		            alert("操作成功");
		    ...
		    // 删除按钮点击事件
		    $(".del").click(function(){
		        var url = "${appDomain}/grpo/delete_grpo.htm?id=" + $(this).attr("alt");
		        if (confirm("确定删除该分组权限？")) {
		    ...
		    $(".approve").click(function(){
		        ...
		        var param = 'dialogWidth=510px;dialogHeight=580px;status=no;center=yes;scroll=no';
		        var val = window.showModalDialog(url, '', param);
		        if (val == 'refresh') {
		            alert("操作成功");
		            $('form').submit();
		    ...
		    $(".delete-btn").click(function(){
		        ...
		        if (confirm("确定删除所选分组权限?")) {
		            ...
		            var url = "${appDomain}/grpo/delete_grpoArray.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
		...
		var url = "${appDomain}/grpo/grpo_detail.htm?id=" + messageId;
    ...
    <body>
        <div id="main">
         <div class="main_nav">
            ...
            <div id="content">                  
                <form id="grpoForm" name="grpoForm" action="${appDomain}/grpo/grpo_list.htm" method="GET">
                <div class="ct-top">
	              <div class="search-bk">
                		<span>分组名称:</span>
