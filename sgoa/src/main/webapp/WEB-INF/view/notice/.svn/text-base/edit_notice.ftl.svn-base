        ...
        <script type="text/javascript">
			...
			$("input[name=textTime]").click(function(){
                ...
                $("#draftBtn").click(function(){
                	...
                	// 添加校验
                	$('form').attr("action", "${appDomain}/notice/draft_notice.htm?edit=true");
    ...
    <body>
		<div id="main">
          <div class="main_nav">
            ...
            <div id="content">
		        <form class="f0" action="${appDomain}/notice/edit_notice.htm" enctype="multipart/form-data" method="POST">
