...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            // 删除按钮点击事件
		    $(".del").click(function(){
		        var url = "${appDomain}/notice/del_notice.htm?id=" + $(this).attr("alt");
		        if (confirm("确定删除该信息？")) {
		    ...
		    $(".delete-btn").click(function(){
		        ...
		        if (item.length == 0) {
		          ...
		          if (confirm("确定删除所选信息？")) {
		            ...
		            var url = "${appDomain}/notice/delete_noticeArray.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
    ...
    <body>
        <div id="main">
         <div class="main_nav">
            ...
            <div id="content">
            	<form id="messageForm" name="messageForm" action="${appDomain}/notice/my_drafts_list.htm" method="GET">
	                ...
	                <div class="ct-top">
	                 <div class="search-bk">
	                    ...
	                    <div class="btn-bk">
	                        <a class="add-btn" href="${appDomain}/notice/add_notice.htm?sort=${sort}">新增</a>
		                        ...
		                        <tr>
		                            ...
		                            <td style="width:60px;"><#if message.sort == 1>通知<#else>公告</#if></td>
		                             <td class="td-btn" width="10%"">
			                            	<a class="act-btn edit" href="${appDomain}/notice/edit_notice.htm?id=${message.id}" title="更新">更新</a>
