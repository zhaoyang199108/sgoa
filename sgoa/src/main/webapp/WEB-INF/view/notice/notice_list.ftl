    ...
    <head>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
			    ...
			    // 撤销按钮点击事件
			    $(".back").click(function(){
			        var url = "${appDomain}/notice/notice_back.htm?id=" + $(this).attr("alt")+"&r=" + Math.random();
			        if (confirm("确定撤销该信息？")) {
    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="messageForm" name="messageForm" action="${appDomain}/notice/list.htm" method="GET">
