    		...
    		<div class="wrap">
		        ...
		        <ul class="select-list">
		            <li>
			            ...
			            <#list messageStepList as messageStep>
			                <li class="zck" id="li_${messageStep.currentOptId}">
			                <input type="radio" class="radioBtn" name="allBtn" alt="${messageStep.currentOptId}" alts="${messageStep.step}" value="" />
			                <span>${messageStep.currentOptName}</span>
			            </li>
		                </#list>
		        </ul>
		        </div>
