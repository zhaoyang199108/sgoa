    		...
    		<div class="wrap">
		        ...
		        <ul class="select-list">
		            <li>
			            ...
			            <#list docoutStepList as docoutStep>
			                <li class="zck" id="li_${docoutStep.currentOptId}">
			                <input type="radio" class="radioBtn" name="allBtn" alt="${docoutStep.currentOptId}" alts="${docoutStep.step}" value="" />
			                <span>${docoutStep.currentOptName}</span>
			            </li>
		                </#list>
		        </ul>
		        </div>
