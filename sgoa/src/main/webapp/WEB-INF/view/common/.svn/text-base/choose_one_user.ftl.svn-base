		...
		<script type="text/javascript">
		    ...
		    $(document).ready(function(){
		        ...
		        $("#doneBtn").click(function(){
		            ...
		            selectUl.each(function(i){
		                userNames =$(this).find("span.uname").text();
		                loginIds = $(this).find("a.opt").attr("alt");
		            });
		    ...
		    function appendDeptUserList(data){
		        ...
		        $.each(data, function(i, user){
		            ...
		            var li = "<li><input type=\"radio\" name=\"loginId\" value=\"" + user.loginId + "\" ";
		    ...
		    function removeUser(loginId){
		        ...
		        $(".user-list li:not(:first)").each(function(){
		            var radio = $(this).find("input[name=loginId]");
		            if (loginId == radio.val()) {
