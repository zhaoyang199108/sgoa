    		...
    		<div class="wrap">
		        ...
		        <ul class="select-list">
		            <li>
			            ...
			            <#list dooutinStepList as dooutinStep>
			            <#if dooutinStep.step!=0>
			                <li class="zck" id="li_${dooutinStep.currentOptId}">
			                <input type="radio" class="radioBtn" name="allBtn" alt="${dooutinStep.currentOptId}" alts="${dooutinStep.step}" value="" />
			                <span>${dooutinStep.currentOptName}</span>
			            </li>
			            </#if>
		                </#list>
		        </ul>
