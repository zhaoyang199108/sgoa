	   ...
	   <script type="text/javascript"  src="${jsDomain}/js/ztree/jquery.ztree.exedit-3.1.js"></script>
		...
		function onRename(e, treeId, treeNode) {
			...
			$(document).ready(function(){
			 	$.ajax({
		            type: 'GET',
		            contentType: 'application/json',
		            url: '${appDomain}/dept/dept_uptate.htm',
		            dataType: 'json',
		...
		function zTreeOnClick(event, treeId, treeNode) {
            ...
            $.ajax({
                type: 'GET',
                contentType: 'application/json',
                url: '${appDomain}/ggtxl/txlgg_list.htm',
                dataType: 'json',
		...
		function addHoverDom(treeId, treeNode) {
			...
			if (btn) btn.bind("click", function(){
			 ...
			 $.ajax({
	            type: 'GET',
	            contentType: 'application/json',
	            url: '${appDomain}/dept/add_dept.htm',
	            dataType: 'json',
		...
		$(document).ready(function(){
	        ...
	        $.ajax({
	            type: 'GET',
	            contentType: 'application/json',
	            url: '${appDomain}/dept/dept_list.htm',
	            dataType: 'json',
	            data: 'r=' + Math.random(),
	            success: function(data){
	            	// 从Controller里取得对象数组
	    ...
	    function appendDeptUserList(data){
	        ...
	        $.each(data, function(i, ggtxl){
	            ...
	            newTr = newTr + "<td class=\"uname\">" + ggtxl.addName + "</td>";
	            newTr = newTr + "<td class=\"uname\">" + ggtxl.duties + "</td>";
	            newTr = newTr + "<td class=\"uname\">" + ggtxl.unitTel + "</td>";
	            newTr = newTr + "<td class=\"uname\">" + ggtxl.cellPhone + "</td></tr>";
