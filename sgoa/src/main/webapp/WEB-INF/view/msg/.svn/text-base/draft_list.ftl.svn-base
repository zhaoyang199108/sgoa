    ...
    <body>
        ...
        <div class="main_nav">
         <#include "msg/menu.ftl">
            <div id="content">                     
                <form id="listForm" name="listForm" action="${appDomain}/msg/draft_list.htm" method="GET">
                   <div class="ct-top">
	                    ...
	                    <table class="list">
	                        ...
	                        <#list page.msgOutboxList as msgOutbox>
								<tr>
									...
									<td class="left"><label style="width:280px;">${msgOutbox.title}</label></td>
									<td class="left">${msgOutbox.receiverNames}</td>
									<td>${msgOutbox.createDate?datetime}</td>	
									<td class="td-btn" width="7%"">
									<a class="act-btn detail"  title="更新"  href="${appDomain}/msg/edit_msgOutbox.htm?id=${msgOutbox.id}">更新</a>
									</td>						
								</tr>
							</#list>
