    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="messageForm" name="messageForm" action="${appDomain}/message/message_review_list.htm" method="GET">
		                        ...
		                        <tr>
		                            ...
		                            <td style="width:60px;"><#if message.sort == 1>通知<#else>公告</#if></td>
		                             <td class="td-btn" width="20%"">
		                             		<a class="act-btn review" href="${appDomain}/message/edit_message_review.htm?id=${message.id}" title="${pageButtonName}">${pageButtonName}</a>
