		...
		<script type="text/javascript">
	    	$(document).ready(function(){
			    ...
			    $(".neirong").click(function(){
			        var url = "${appDomain}/message/content_detail.htm?dRecordid=" + $(this).attr("alt") + "&r=" + Math.random();
 			...
 			<table class="ftb">
		               ...
		               <tr>
		                ...
		                <tr>
		                    ...
		                    <td colspan="3">
  								<a style="color:red; text-decoration: underline;" class="neirong" href="#" title="点击查看详细内容" alt="${message.dRecordid}">点击查看详细内容</a>
  		                    </td>
		                </tr>
		          <#list page.messageReviewList as messageReview>
				  <tr>
				    <th>审核意见：
