	...
	<script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#draftBtn").click(function(){
                	...
                	// 添加校验
                	$('form').attr("action", "${appDomain}/message/add_message_review.htm");
                	 if(DoCheckSubmit())
                    {
                    if(SaveSignature()) {
                    	$('form').submit();
		    ...
		    $("#rebackBtn").click(function(){
                    ...
                    $('form').attr("action", "${appDomain}/message/message_reback.htm");
		    		 if(DoCheckSubmit())
                    {
                    	if(SaveSignature()) {
                    	$('form').submit();
...
<div id="main">
	...
	<#include "message/menu.ftl">
		<div id="content">
			 <form class="f0" action="${appDomain}/message/add_message_review.htm" method="POST">
			  <div class="ct">
				<table class="ftb">
				  ...
				  <tr>
		                    ...
		                    <td colspan="3">
		                        <input class="title" type="text" id="title" name="title" value="${message.title}" readonly="readonly"/>
		                    </td>
		                </tr>
		                 <tr>
		                    <th> 主题词:</th>
				...
				<#list onePage.messageReviewList as messageReview>
				  <tr>
				    ...
				    <td colspan="3">
				    <label>
					<OBJECT id="SendOutView${messageReview_index}" classid="clsid:2294689C-9EDF-40BC-86AE-0438112CA439" codebase="${jsDomain}/js/iWebRevision/iWebRevision.cab#version=6,6,0,294" width=100% height=100%>
			    ...
			    <tr>
				  ...
				  <tr class="act">
                    ...
                    <#if approvalDetailForStatus == 'Y'>
		             ...
		             <input id="rebackBtn" class="btn" name="draftBtn" type="button" alt="${message.id}" value="返回修改" />
		              </#if>
