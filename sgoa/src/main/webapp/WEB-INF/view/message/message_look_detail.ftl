...
<html>
    <head>
        ...
        <title><#if message.sort=='1'>通知</#if>
        		<#if message.sort=='2'>公告</#if></title>
...
<div id="main">
	<div class="main_nav">
	<h3 class="title02"><font size="3"><strong>${message.title}</strong></font></h3>
...
<div class="tab1" id="tab1">
	<div class="menu">
		<ul>
			...
			<li id="one1" onclick="setTab('one',1)"><img src="${imageDomain}/images/c01.png"/><#if message.sort=='1'>通知</#if>
        		<#if message.sort=='2'>公告</#if></li>
		</ul>
	</div>
	<div class="menudiv">
		<div id="con_one_1">  
		...
		<div id="con_one_2" style="display:none;">
			...
			<table width="200" border="0"  class="wj_pap">
			  ...
			  <tr>
			    <th>拟　　稿</th>
			    <td>${message.draftsName}</td>
			    <th class="ee">签　　发</th>
			    <td>${message.currentOptName}</td>
			  </tr>
			  <tr>
			    <th>拟稿部门</th>
			    <td>${message.draftsDeptName}</td>
			    <th class="ee">发布时间</th>
			    <td>${message.textTime}</td>
			  </tr>
			  <tr>
			    <th valign="top" class="bhr" >意　　见</th>
			    <td colspan="3" height="100" >${message.remark}</td>
			  </tr>
			  <tr>
			  	<th align="left" class="bh02">已读（${messageLookListForAll?size}条）</th>
			  ...
			  <tr>
				<td colspan="4" align="left" class="ziti">
				    <#list messageLookListForAll as messageLook>
						<span>${messageLook.loginName} 【${messageLook.deptName} | ${messageLook.createDate?datetime}】</span>
	            	</#list>
				</td>
			  </tr>
			</table>
