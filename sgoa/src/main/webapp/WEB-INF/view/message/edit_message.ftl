        ...
        <script type="text/javascript">
			...
			$("input[name=textTime]").click(function(){
                ...
                $("#draftBtn").click(function(){
                	...
                	// 添加校验
                	$('form').attr("action", "${appDomain}/message/draft_message.htm?edit=true");
    ...
    <body>
		<div id="main">
          <div class="main_nav">
            ...
            <div id="content">
		        <form class="f0" action="${appDomain}/message/edit_message.htm" enctype="multipart/form-data" method="POST">
		        	<input type="hidden" id="currentOptId" name="currentOptId" value="${message.currentOptId}" />
		        	<input type="hidden" id="nextOptId" name="nextOptId" value="" />
		        	<input type="hidden" id="status" name="status" value="" />
		        	<input type="hidden" id="dRecordid" name="dRecordid" value="${message.dRecordid}" />
		            ...
		            <table class="ftb">
		                <tr>
		                    ...
		                    <td colspan="3">
		                        <input class="title" type="text" name="title" value="${message.title}" />
		                    </td>
		                </tr>
		                 <tr>
		                    <th> 主题词:</th>
		                    <td>
		                        <input class="txt" type="text" name="subject" value="${message.subject}" />
		                    </td>
		                    <th>
		                      	  拟稿人：
		                    </th>
		                ...
		                <tr>
		                    ...
		                    <td>
		                        <input class="txt" type="text" name="textTime" value="${message.textTime}" />
		                    </td>
		                    <th> 拟稿部门:</th>
		                    <td>
		               ...
		               <tr>
		                ...
		                <tr>
				     	<th>备注:</th>
						<td colspan="3">
						<textarea class="woe" name="remark">${message.remark}</textarea>
						</td>
					    </tr>
		                <tr class="act">
		                    <td colspan="4">
