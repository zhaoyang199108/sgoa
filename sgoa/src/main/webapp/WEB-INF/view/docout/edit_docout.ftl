			...
			$("input[name=textTime]").click(function(){
			 ...
			 /**
                ...
                $("#draftBtn").click(function(){
                	...
                	// 添加校验
                	$('form').attr("action", "${appDomain}/docout/draft_docout.htm?edit=true");
		...
		<div id="main">
          <div class="main_nav">
            ...
            <div class="pst"><h4>四川省新闻出版广电局发文</h4>
		        <form class="f0" action="${appDomain}/docout/edit_docout.htm" enctype="multipart/form-data" method="POST">
		        	<input type="hidden" id="currentOptId" name="currentOptId" value="${docout.currentOptId}" />
		        	<input type="hidden" id="nextOptId" name="nextOptId" value="" />
		        	<input type="hidden" id="status" name="status" value="" />
		        	<input type="hidden" id="dRecordid" name="dRecordid" value="${docout.dRecordid}" />
		        	<input type="hidden" id="enabled" name="enabled" value="" />
		        	<input class="text" type="hidden" id="step"  name="step" value="1"  />
		        	<input type="hidden" id="id" name="id" value="${docout.id}" />
		        	<table class="st">
		            <tr>
					  ...
					  <tr>
					    <th>印　　刷：</th>
					    <td><input type="text" name="printing" value="${docout.printing}"/></td>
					    <th>校　　对：</th>
					    <td><input type="text" name="proofread" value=""/></td>
					    <th>份　　数：</th>
					    <td><input type="text" name="copies" value="${docout.copies}" /></td>
					  </tr>
					  <tr>
		                      <th>
		                      	  流程名称：
					  ...
					  <tr>
					    <th>主 题 词：</th>
					    <td colspan="5">
					      <input type="text" name="subject" class="wid"  value="${docout.subject}" />
					    </td>
					    </tr>
					  <tr>
					    <th>标　　题：</th>
					    <td colspan="5"><input type="text" name="title" class="wid"  value="${docout.title}"/></td>
					    </tr>
		                <tr class="act">
		                    <td colspan="6">
