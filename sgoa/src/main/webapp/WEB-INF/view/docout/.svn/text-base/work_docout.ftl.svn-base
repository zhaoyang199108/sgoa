...
<head>
	...
	<script type="text/javascript">
			...
			$("#saveBtn").click(function(){
		        ...
		        $('form').attr("action", "${appDomain}/docout/add_docout_work.htm");
		    	 if(DoCheckSubmit())
                    {
                    	if(SaveSignature()) {
                    	$('form').submit();
		    ...
		    $("#rebackBtn").click(function(){
                    ...
                    $('form').attr("action", "${appDomain}/docout/dooutin_reback.htm");
		    		 if(DoCheckSubmit())
                    {
                    	if(SaveSignature()) {
                    	$('form').submit();
...
<div id="main">
	...
	<#include "docout/menu.ftl">
		...
		<div class="pst"><h4>四川省新闻出版广电局发文</h4>
			 <form class="f0" action="${appDomain}/docout/add_docout_work.htm" method="POST">
				<table class="st">
				  ...
				  <tr>
					  ...
					  <tr>
					    ...
					    <th>校　　对：</th>
					    <td><input type="text" name="proofread" id="proofread" value="" readonly="readonly"/></td>
					    <th>份　　数：</th>
				  ...
				  <tr>
				    <th>${docoutReview.currentOptName}意见：
				  ...
				  <tr class="act">
                    <td colspan="6">
	                    <#if approvalDetailForStatus == 'Y'>
						    <input id="submitBnt" class="btn" name="draftBtn" type="button" value="校对完毕" />
						</#if>
						<#if stepNext!=null>
			                <input id="saveBtn" class="btn" name="draftBtn" type="button" value="${pageButtonName}" />
			             </#if>
			             <#if docout.steps!=1 && docout.draftsId!=docout.nextOptId>
			             <input id="rebackBtn" class="btn" name="draftBtn" type="button" alt="${docout.id}" value="返 回" />
			             </#if>
