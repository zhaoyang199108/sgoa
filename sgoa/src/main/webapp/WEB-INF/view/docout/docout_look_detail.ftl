			...
			<form id="docoutForm" name="docoutForm" action="" method="GET">
 			<table class="st">
		            <tr>
					  ...
					  <tr>
					    <th>意见：
					    	<input alt="${docoutReview_index}" class="signBtn" name="signBtn" type="hidden" value="手写签名" />
					    </th>
					    <td colspan="5">
					    <label>
				   ...
				   <input class="txt"  type="hidden" id="currentOptId" name="currentOptId" value="" />${docoutReview.currentOptName}</span>
					  ...
					  <tr>
				  	 ...
				  	 <th> 已读科室：  </th>
					    <td colspan="5">
							<#list docoutLookListForAll as docoutLook>
								${docoutLook.loginName}【${docoutLook.createDate?datetime}】，
				            	</#list>
						 </td>
					</tr>
		            </table>
