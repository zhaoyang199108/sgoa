    ...
    <body>
        <div id="main">
          <div class="main_nav">
            ...
            <div id="content">
            	<form id="docoutForm" name="docoutForm" action="${appDomain}/docout/docout_doinout_list.htm" method="GET">
	                <div class="ct-top">
	                	<div class="search-bk">
							<span>标题：</span>
		                        ...
		                        <tr>
		                            ...
		                            <td>${docout.docoutNum}</td>
		                             <td class="td-btn" width="15%"">
		                             		<a class="act-btn review" href="${appDomain}/docout/edit_docout_work.htm?id=${docout.id}" title="${pageButtonName}">${pageButtonName}</a>
