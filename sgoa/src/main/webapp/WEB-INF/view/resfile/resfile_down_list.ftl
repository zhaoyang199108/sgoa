    ...
    <head>
		...
		$(document).ready(function(){
			...
			$("#ct").xheditor({
                ...
                var param = 'dialogWidth=760px;dialogHeight=500px;status=no;center=yes;scroll=yes';
		    ...
		    $("#addBtn").click(function(){
		        ...
		        var param = 'dialogWidth=760px;dialogHeight=560px;status=no;center=yes;scroll=yes';
		    ...
		    // 删除按钮点击事件
		    $(".del").click(function(){
		        var url = "${appDomain}/resShareDown/delete.htm?id=" + $(this).attr("alt");
		    ...
		    $("#delBatchBtn").click(function(){
		        ...
		        if (confirm("确定删除所选公告？")) {
		            ...
		            var url = "${appDomain}/resShareDown/delete_batch.htm"
		            $.get(url, {
		                idArray: value
		            }, function(result){
		                alert("操作成功");
        ...
        <div id="main">
         <#include "resfile/menu.ftl">
            <div id="content">
                ...
                <form id="listForm" name="listForm" action="${appDomain}/resFile/shareDownList.htm" method="GET">
	                    ...
	                    <table class="list">
	                        ...
	                        <#list page.resFileList as resFile >
								<tr>
									...
									<td class="left" width="35%"><label style="width:240px;">${resFile.content}</label></td>
									<td >${resFile.srcFileName}</td>
									<td>${resFile.updateDate?date}</td>
									<td class="td-btn" width="10%""><a class="act-btn edit" href="#" title="查看" alt="${resFile.id}">查看</a>
									<a class="act-btn act-down" href="#" alt="${resFile.srcFileName}">下载</a></td>
								</tr>
							</#list>
	                        </tr>
	                    </table>
