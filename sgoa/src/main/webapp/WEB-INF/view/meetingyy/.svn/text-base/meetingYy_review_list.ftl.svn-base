    ...
    <body>
        <div id="main">
         <div class="main_nav">
            ...
            <div id="content">                  
                <form id="userForm" name="userForm" action="${appDomain}/meetingYy/meetingYy_review_list.htm" method="GET">
                <div class="ct-top">
	              <div class="search-bk">
						<span>会议室:</span>
	                        ...
	                        <#list page.meetingYyList as meetingYy>
								<tr>
									...
									<td class="td-btn" width="15%">
										...
										<#if meetingYy.status == '2' || meetingYy.status == '1'>
										<a class="act-btn edit" href="${appDomain}/meetingYy/edit_meetingYy_review.htm?id=${meetingYy.id}" title="审批">审批</a>
										<#else>
										<a class="act-btn edit" title="审批">审批</a>
										</#if>
