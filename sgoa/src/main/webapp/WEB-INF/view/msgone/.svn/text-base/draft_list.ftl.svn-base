    ...
    <body>
        ...
        <div class="main_nav">
         <#include "msgone/menu.ftl">
            <div id="content">                     
                <form id="listForm" name="listForm" action="${appDomain}/msgone/draft_list.htm" method="GET">
                   <div class="ct-top">
	                    ...
	                    <table class="list">
	                        ...
	                        <#list page.msgoneOutboxList as msgoneOutbox>
								<tr>
									...
									<td class="left"><label style="width:280px;">${msgoneOutbox.title}</label></td>
									<td class="left">${msgoneOutbox.receiverNames}</td>
									<td>${msgoneOutbox.createDate?datetime}</td>	
									<td class="td-btn" width="7%"">
									<a class="act-btn detail"  title="更新"  href="${appDomain}/msgone/edit_msgoneOutbox.htm?id=${msgoneOutbox.id}">更新</a>
									</td>						
								</tr>
							</#list>
