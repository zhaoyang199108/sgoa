          ...
          <div class="main_nav">
			...
			<form id="swForm" name="swForm" action="" method="GET">
 			<table class="stty">
					  ...
					  <tr>
					  	<th>签收人</th>
					  	<th colspan="2">处理结果</th>
					  	<th colspan="2">签收状态</th>
					  	<th colspan="2">签收时间</th>
					  </tr>
					  <#list page.swHuList as swHu>
				  		<tr>
					    <td style="text-align:center;width:12%;">${swHu.loginName}</td>
						<td colspan="2" style="text-align:left;">${swHu.bljg}</td>
						<td colspan="2" style="text-align:center;">
						<#if swHu.isqs == 1>签收</#if>
	                    <#if swHu.isqs == 2>未签收</#if>
						</td>
						<td colspan="2" style="text-align:center;width:15%;">${swHu.createDate?datetime}</td>
					  </tr>
				   	  </#list>
		            </table>
		       </form>
