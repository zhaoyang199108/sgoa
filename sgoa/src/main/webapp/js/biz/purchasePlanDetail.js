...
$(document).ready(function() {
	...
	$("#addBtn").click(function() {
		var trCount = $("#boundTb tr").size() - 1; // 采购总行数
...
// *************************************追加结束*********************************
	...
	$("#submitBtn").click(function(){
        if(!confirm("请选择审批人!")){
	        ...
	        // 添加校验
	        // 选择提交审核人
	        var url = "/common/choose_user.htm?level=23" + "&r=" + Math.random();
       ...
       $("#submitBut").click(function(){
	        ...
	        // 添加校验
	        // 选择提交审核人
	        var url = "/common/choose_user.htm?level=22" + "&r=" + Math.random();
	        var param = 'dialogWidth=380px;dialogHeight=380px;status=no;center=yes;scroll=yes';
	        ...
	        if(!confirm("是否确定提交?")){
	        	return false;
		         ...
		         $.ajax({
		            ...
		            dataType: 'json',
		            data: 'userLoginId=' + $("#nextOptId").val() + '&memo=' + encodeURI(encodeURI("您有新的物资设备采购计划需要审批！")) + '&r=' + Math.random(),
