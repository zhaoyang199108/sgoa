package com.bcqsoft.sgoa.dao.newsreview.dataobject;
...
public class NewsReviewPage {
	 ...
	 * 通知公告集合
	 */
	private List<NewsReview> newsReviewList;
	...
	public List<NewsReview> getNewsReviewList() {
		return newsReviewList;
	}

	public void setNewsReviewList(List<NewsReview> newsReviewList) {
		this.newsReviewList = newsReviewList;
	}
