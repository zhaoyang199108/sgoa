package com.bcqsoft.sgoa.dao.msgoneinbox.dataobject;
 ...
 * </pre>
 */
public class MsgoneInboxPage extends BasePage {

	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = 5106712214124515880L;

	List<MsgoneInbox> msgoneInboxList;
	...
	public List<MsgoneInbox> getMsgoneInboxList() {
		return msgoneInboxList;
	}

	public void setMsgoneInboxList(List<MsgoneInbox> msgoneInboxList) {
		this.msgoneInboxList = msgoneInboxList;
	}
