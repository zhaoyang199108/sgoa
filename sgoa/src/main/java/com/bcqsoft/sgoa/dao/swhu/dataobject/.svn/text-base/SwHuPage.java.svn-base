 ...
 * </pre>
 */
public class SwHuPage extends BasePage {
	...
	public List<SwHu> getSwHuList() {
		return swHuList;
	}
	public void setSwHuList(List<SwHu> swHuList) {
		this.swHuList = swHuList;
	}
