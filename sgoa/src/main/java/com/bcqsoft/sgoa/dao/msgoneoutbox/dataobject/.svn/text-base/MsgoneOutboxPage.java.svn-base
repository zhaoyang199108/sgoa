package com.bcqsoft.sgoa.dao.msgoneoutbox.dataobject;
 ...
 * </pre>
 */
public class MsgoneOutboxPage extends BasePage {

	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = 3851232651212696229L;

	List<MsgoneOutbox> msgoneOutboxList;
	/**
	 * 自增型主键
	 */
	private Long id;
	...
	public List<MsgoneOutbox> getMsgoneOutboxList() {
		return msgoneOutboxList;
	}

	public void setMsgoneOutboxList(List<MsgoneOutbox> msgoneOutboxList) {
		this.msgoneOutboxList = msgoneOutboxList;
	}
