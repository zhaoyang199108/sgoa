package com.bcqsoft.sgoa.dao.msgoutbox.dataobject;
 ...
 * </pre>
 */
public class MsgOutboxPage extends BasePage {
	...
	public List<MsgOutbox> getMsgOutboxList() {
		return msgOutboxList;
	}

	public void setMsgOutboxList(List<MsgOutbox> msgOutboxList) {
		this.msgOutboxList = msgOutboxList;
	}
