...
public class MeetingYyReviewPage extends BasePage{
	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = 3009748091476311264L;
	
	/**
	 * 会议审批列表
	 */
	private List<MeetingYyReview> meetingYyReviewList;
	...
	public List<MeetingYyReview> getMeetingYyReviewList() {
		return meetingYyReviewList;
	}

	public void setMeetingYyReviewList(List<MeetingYyReview> meetingYyReviewList) {
		this.meetingYyReviewList = meetingYyReviewList;
	}
