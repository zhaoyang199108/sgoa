package com.bcqsoft.sgoa.dao.docoutreview.dataobject;
 ...
 * 
 * <pre>
 * 表: SCOA_TB_DOCOUT_REVIEW
 * </pre>
 */
public class DocoutReviewPage {
	
	/**
	 * 通知公告集合
	 */
	private List<DocoutReview> docoutReviewList;
	...
	public List<DocoutReview> getDocoutReviewList() {
		return docoutReviewList;
	}

	public void setDocoutReviewList(List<DocoutReview> docoutReviewList) {
		this.docoutReviewList = docoutReviewList;
	}
