 ...
 * </pre>
 */
public class MsgInboxPage extends BasePage {
	...
	public List<MsgInbox> getMsgInboxList() {
		return msgInboxList;
	}

	public void setMsgInboxList(List<MsgInbox> msgInboxList) {
		this.msgInboxList = msgInboxList;
	}
