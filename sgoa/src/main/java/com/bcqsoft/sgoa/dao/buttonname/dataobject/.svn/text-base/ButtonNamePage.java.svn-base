...
public class ButtonNamePage extends BasePage {
	private static final long serialVersionUID = -5622021560288626237L;
	
	/**
	 * 按钮名称列表
	 */
	private List<ButtonName> buttonNameList;
	...
	public List<ButtonName> getButtonNameList() {
		return buttonNameList;
	}

	public void setButtonNameList(List<ButtonName> buttonNameList) {
