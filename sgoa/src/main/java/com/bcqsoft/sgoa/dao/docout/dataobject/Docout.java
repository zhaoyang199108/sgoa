...
public class Docout {
	...
	public String getMainSendName() {
		return mainSendName;
	}

	public void setMainSendName(String mainSendName) {
		this.mainSendName = mainSendName;
	}

	public String getCopySendName() {
		return copySendName;
	}

	public void setCopySendName(String copySendName) {
		this.copySendName = copySendName;
	}
