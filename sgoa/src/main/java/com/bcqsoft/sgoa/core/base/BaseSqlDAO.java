 ...
 * 所有DAO需继承此类<br>
 */
public class BaseSqlDAO extends SqlMapClientDaoSupport {

	/**
	 * sqlMapClient
	 */
	@Resource(name = "sqlMapClientSql")
	private SqlMapClient sqlMapClientSql;
	...
	public void initSqlMapClient() {
		super.setSqlMapClient(sqlMapClientSql);
	}
