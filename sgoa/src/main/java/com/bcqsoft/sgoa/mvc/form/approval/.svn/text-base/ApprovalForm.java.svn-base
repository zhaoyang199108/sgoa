package com.bcqsoft.sgoa.mvc.form.approval;
...
public class ApprovalForm extends BaseForm {
	...
	public String[] getDraftsNames() {
		return draftsNames;
	}

	public void setDraftsNames(String[] draftsNames) {
		this.draftsNames = draftsNames;
	}
