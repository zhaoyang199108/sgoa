package com.bcqsoft.sgoa.mvc.form.user;
...
public class UserForm extends BaseForm {
	 ...
	 * 取得紧急联系电话
	 */
	public String getUrgentUserTell() {
		return urgentUserTell;
	}

	/**
	 * 设置紧急联系电话
	 */
	public void setUrgentUserTell(String urgentUserTell) {
		this.urgentUserTell = urgentUserTell;
	}

	/**
	 * 取得出生日期(格式:2011-11-22)
	 */
	...
	public void setGrpoId(Long grpoId) {
		this.grpoId = grpoId;
	}
	...
	public Long getOldGrpoId() {
		return oldGrpoId;
	}

	public void setOldGrpoId(Long oldGrpoId) {
		this.oldGrpoId = oldGrpoId;
	}
