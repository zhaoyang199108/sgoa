...
$(document).ready(function() {
	...
	$("table.list tr:not(:first)").mouseover(function() {
		$(this).css("background-color", "#FFFAEE");
	});
...
function getNowYmdHmDate() {	
	...
	var resultDate = date.getFullYear() + seperator1 + fullDate(month) + seperator1 + fullDate(strDate) + " " + fullDate(hours) + seperator2 + fullDate(minutes);
	return resultDate;
}
